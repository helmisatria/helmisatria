...
Maaf, `snscrape` sudah tidak bisa digunakan karena ada perubahan fitur dari twitter. Silahkan gunakan `tweet-harvest` yang sudah saya buat sendiri untuk keperluan riset, skripsi, ataupun thesis (tidak untuk diperjualbelikan) bisa cek link nya disini: https://helmisatria.com/blog/crawl-data-twitter-menggunakan-tweet-harvest
