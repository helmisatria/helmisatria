...
description: "snscrape sudah tidak bisa digunakan karena ada perubahan fitur dari twitter. Silahkan gunakan `tweet-harvest` yang sudah saya buat sendiri untuk keperluan riset, skripsi, ataupun thesis"
...
- ```
    ...
    akan mengembalikan tweet hanya dari akun Twitter Barack Obama.

- ```
    #hashtag
    ```

    : tweet yang mengandung hashtag tertentu
...
- ```
    ...
    : tweet yang menyebutkan pengguna tertentu
    ...
    akan mengembalikan tweet yang menyebutkan Elon Musk.

- ```
    keyword1 OR keyword2
    ```

    : tweet yang mengandung keyword1 atau keyword2
    ...
    akan mengembalikan tweet yang mengandung keyword "pizza" atau keyword "pasta".

- ```
    since:yyyy-mm-dd until:yyyy-mm-dd
    ```

    : tweet yang diposting antara dua tanggal

    Misalnya, mencari

    ```
    COVID19 since:2022-01-01 until:2022-01-31
    ```

    akan mengembalikan tweet yang mengandung keyword "COVID19" yang diposting antara 1 Januari 2022 dan 31 Januari 2022.

- ```
    near:city within:km
    ```

    : tweet yang diposting di dekat lokasi tertentu

    Misalnya, mencari

    ```
    near:Jakarta within:15km
    ```

    akan mengembalikan tweet yang diposting dalam jarak 15 kilometer dari Jakarta.

- ```
    key1 AND key2
    ```

    : tweet yang mengandung key1 dan key2
    ...
    hanya akan mengembalikan tweet yang mengandung "cat" dan "dog".

- ```
    "presiden Indonesia"
    ```

    : tweet yang mengandung frase tepat
    ...
    hanya akan mengemb alikan tweet yang mengandung frase "presiden Indonesia".

- ```
    min_replies
    ```

    : tweet dengan jumlah balasan minimum. Misalnya, menambahkan `min_replies:10` pada pencarian kamu hanya akan mengembalikan tweet yang memiliki setidaknya 10 balasan.

- ```
    min_faves
    ```

    : tweet dengan jumlah like (favorit) minimum
    ...
    pada pencarian kamu hanya akan mengembalikan tweet yang memiliki setidaknya 100 like.

- ```
    min_retweets
    ```

    : tweet dengan jumlah retweet minimum
    ...
    pada pencarian kamu hanya akan mengembalikan tweet yang memiliki setidaknya 50 retweet. Untuk daftar lengkap operator, lihat dokumentasi Twitter Search API.
